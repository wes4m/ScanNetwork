...
<link href="<?php echo base_url();?>assest/css/docs.css" rel="stylesheet">
  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      ...
      -->
        <li>
          <a href="<?php echo base_url();?>contribt">Contribute</a>
        </li>
        <li>
...
<script src="<?php echo base_url();?>assest/js/bootstrap.file-input.js"></script>
...
window.location = "<?php echo base_url();?>home/results/"+filehash;
});
    $('#scan').click(function(){
